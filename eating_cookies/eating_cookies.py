...
#     # Your code here
#     # check to see all the ways cookies can be eaten up to 3 at a time 
#     if n < 0:
#         return 0
#     elif n == 0:
#         return 1
#     else:
#         return eating_cookies(n-1) + eating_cookies(n-2) + eating_cookies(n-3) # O(3^n)
